...
import { handleSlackWebhook, getPublicChatReadiness } from '@/lib/hireproof-bot'
  ...
  return Response.json(
    {
      ...
      readiness: getPublicChatReadiness('slack'),
    },
...
export async function POST(request: Request) {
  ...
  return handleSlackWebhook(cloneRequestWithTextBody(request, parsedBody.value), { waitUntil })
}
