...
import { handleDiscordWebhook, getPublicChatReadiness } from '@/lib/hireproof-bot'
  ...
  return Response.json(
    {
      ...
      readiness: getPublicChatReadiness('discord'),
    },
...
export async function POST(request: Request) {
  ...
  return handleDiscordWebhook(cloneRequestWithTextBody(request, parsedBody.value), { waitUntil })
}
