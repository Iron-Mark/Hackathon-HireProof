  ...
  return (
    <div>
      ...
      <section className="mb-10">
        <h2 className="mb-3 text-2xl font-black">Listed on Marketplaces</h2>
        <p className="mb-4 text-sm font-semibold text-muted">Find and install HireProof from the public SKILL.md marketplaces:</p>
