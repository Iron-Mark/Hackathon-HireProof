...
<main class="stage">
  ...
  <section class="browser"><div class="bar"><span class="dot"></span><span class="dot"></span><span class="dot"></span><div class="url">chrome-extension://hireproof/popup.html</div></div><div class="popup">
    ...
    <div class="status">Human-filter active</div><label>API Server URL</label><input value="https://hireproof.tech" /><label>API Key</label><input placeholder="Paste your API key" /><div class="actions"><button class="primary">Scan This Page</button><button class="secondary">Paste & Check</button></div>
  </div></section>
</main>`)
