...
const SEARCH_INDEX: SearchItem[] = [
  ...
  { id: 'docs-quickstart', title: 'Quickstart', description: 'Run HireProof locally and try a configured demo-mode API request.', href: '/docs/quickstart', category: 'Docs', icon: Terminal, keywords: ['install', 'local', 'setup', 'demo mode'], priority: 7 },
